...
const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Discreption" />
    ),
    cell: ({ row }) => (
...
function TransactionTable({ from, to }: Props) {
  const [sorting, setSortin] = useState<SortingState>([]);
